...
GAMEOPTIONS gSingleGameOptions = {
    GAMETYPE_0, DIFFICULTY_2, 0, 0, "", "", 2, "", "", 0, 0, 0, (MONSTERSETTINGS)MONSTERSETTINGS_1, 0, 0, (WEAPONSETTINGS)WEAPONSETTINGS_0, (ITEMSETTINGS)ITEMSETTINGS_0, (RESPAWNSETTINGS)RESPAWNSETTINGS_0, DIFFICULTY_2, DIFFICULTY_2, 3600, 1800, 1800, 7200
};

GAMEOPTIONS gBloodBathGameOptions = {
    GAMETYPE_2, DIFFICULTY_2, 0, 0, "", "", 2, "", "", 0, 0, 0, (MONSTERSETTINGS)MONSTERSETTINGS_0, 0, 1, (WEAPONSETTINGS)WEAPONSETTINGS_1, (ITEMSETTINGS)ITEMSETTINGS_2, (RESPAWNSETTINGS)RESPAWNSETTINGS_0, DIFFICULTY_2, DIFFICULTY_2, 3600, 1800, 1800, 7200
};

GAMEOPTIONS gCoopGameOptions = {
    GAMETYPE_1, DIFFICULTY_2, 0, 0, "", "", 2, "", "", 0, 0, 0, (MONSTERSETTINGS)MONSTERSETTINGS_1, 0, 0, (WEAPONSETTINGS)WEAPONSETTINGS_1, (ITEMSETTINGS)ITEMSETTINGS_0, (RESPAWNSETTINGS)RESPAWNSETTINGS_0, DIFFICULTY_2, DIFFICULTY_2, 3600, 1800, 1800, 3600
};

GAMEOPTIONS gTeamGameOptions = {
    GAMETYPE_3, DIFFICULTY_2, 0, 0, "", "", 2, "", "", 0, 0, 0, (MONSTERSETTINGS)MONSTERSETTINGS_0, 0, 1, (WEAPONSETTINGS)WEAPONSETTINGS_2, (ITEMSETTINGS)ITEMSETTINGS_1, (RESPAWNSETTINGS)RESPAWNSETTINGS_0, DIFFICULTY_2, DIFFICULTY_2, 3600, 1800, 1800, 7200
};
int gNextLevel;
